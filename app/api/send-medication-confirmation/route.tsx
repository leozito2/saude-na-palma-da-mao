...
export async function POST(request: NextRequest) {
  try {
            ...
            <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background: linear-gradient(135deg, #EFF6FF 0%, #D1FAE5 100%);">
              <div style="max-width: 600px; margin: 40px auto; padding: 20px;">
                ...
                <div style="background: white; padding: 40px; border-radius: 0 0 20px 20px;">
                  <h2 style="color: #1F2937; margin: 0 0 20px 0; font-size: 24px;">✅ Medicamento Cadastrado!</h2>
                  
                  <p style="color: #4B5563; line-height: 1.6; margin: 0 0 20px 0;">
                    Seu medicamento foi cadastrado com sucesso! Confira os detalhes abaixo:
                  </p>
                  ...
                  <div style="background: #F3F4F6; border-radius: 12px; padding: 20px; margin: 0 0 20px 0;">
                    <table style="width: 100%; border-collapse: collapse;">
                      ...
                      <tr>
                        ...
                        <td style="padding: 8px 0; color: #1F2937; font-weight: 600; text-align: right;">${tipo}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">💉 Dose:</td>
                        <td style="padding: 8px 0; color: #1F2937; font-weight: 600; text-align: right;">${dose}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">⏰ Horário:</td>
                        <td style="padding: 8px 0; color: #1F2937; font-weight: 600; text-align: right;">${horario_uso}</td>
                      </tr>
                      <tr>
                        <td style="padding: 8px 0; color: #6B7280; font-size: 14px;">📅 Vencimento:</td>
                        <td style="padding: 8px 0; color: #1F2937; font-weight: 600; text-align: right;">${formatDate(data_vencimento)}</td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div style="background: #DBEAFE; border-left: 4px solid #3B82F6; padding: 15px; border-radius: 8px; margin: 0 0 20px 0;">
                    <p style="color: #1E40AF; font-size: 13px; margin: 0; line-height: 1.5;">
                      💡 <strong>Lembrete:</strong> Você receberá notificações 15 e 5 minutos antes do horário de uso.
                    </p>
                  </div>
    ...
    console.error("[v0] Error sending medication confirmation:", error)
